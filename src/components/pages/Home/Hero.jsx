...
const Hero = () => {
  return (
    ...
    <div class="relative">
      <div class="bg-secondary  flex items-center justify-center py-5 ">
        <img src={banner} alt="Best Dental Clinic in Hyderabad - Gnathos Dental" class="w-[80vw] h-[60vh]  object-cover rounded-2xl"/>
      </div>

      {/* <!-- Rating Badge --> */}
      <div class="absolute top-2 left-30  bg-white p-4 rounded-xl shadow-lg">
